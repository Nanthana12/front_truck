      ...
      <v-card class="card-shadow" rounded="lg">
        ...
        <v-card-text class="pa-8">
          ...
          <div style="" class="d-flex align-center mt-6">
            <div
              style="display:flex;flex-direction:row;justify-content:space-between;width:100%;background-color:#f5f5f5;border-radius:5px"
              class="mr-6 px-4 pt-5">
              <div style="width:100%" class="mr-0"><v-text-field label="ບ້ຽງລ້ຽງ" outlined dense v-model="money"
                  :rules="nameRules"></v-text-field></div>
              <div style="width:100%" class="pl-2"><v-text-field label="ບ້ຽງລ້ຽງຈ່າຍກ່ອນ" outlined dense
                  v-model="money_aready_pay" :rules="nameRules"></v-text-field></div>
    ...
    <div style="display:none;">
      <div id="modalInvoice">
        ...
        <div style="display:flex;justify-content:end;flex-direction:column;align-items:end">
          <span style="font-size:12pt">ເລກທີ: {{ leave_id_car }}</span>
          <span style="font-size:12pt">ວັນທີອອກລົດ: {{ start_go_date }}</span>
        ...
        <!-- products -->
        <div style="display:flex;flex-direction:row;justify-content:space-between;">
          <div style="width:80%;display:flex;align-items:end"><span style="font-size:12pt">ຊື່ສິນຄ້າ: {{ product_name
          }}</span>
          </div>
          <!-- <div style="width:100%"><span style="font-size:12pt">ຈຳນວນ: {{ product_quality }}</span></div> -->
          <div style="width:100%"><span style="font-size:12pt">ນໍ້າໜັກ: {{ product_weight }} ໂຕນ</span></div>
        </div>
        <div style="display:flex;flex-direction:row;justify-content:space-between;">
        ...
        <div style="display:flex;flex-direction:row;justify-content:space-between;">
          ...
          <div style="width:100%"><span style="font-size:12pt">ຄ້າງຈ່າຍ: {{ money_still_pay }} {{ currency1 }}</span>
          </div>
        </div>
