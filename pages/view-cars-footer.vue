                            ...
                            <div style="width:100%">
                                ...
                                <div style="background-color:#f5f5f5;border-radius:5px" class="pa-2">
                                    <div class="d-flex">
                                        ...
                                        <v-text-field class="ml-2" :rules="nameRules" dense readonly label="ວັນທີປ່ຽນຢາງ"
                                            v-model="l_TRIES_DATE_1"></v-text-field>
                                        <v-text-field class="ml-2" :rules="nameRules" dense readonly label="ກຳນົດແລ່ນໄດ້ km"
...
export default {
    ...
    methods: {
        ...
        async ongetData() {
            try {
                await this.$axios.$post('/listViciclefooterByID.service', { key_id: this.$route.query.key }).then((data) => {
